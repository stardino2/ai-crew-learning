...
function renderMaintenance(maintenance) {
  ...
  banner.hidden = false;
  document.querySelector("#maintenance-title").textContent = `${maintenance.serviceName} 예정 점검`;
  document.querySelector("#maintenance-message").textContent = maintenance.message;
  document.querySelector("#maintenance-window").textContent =
    `${formatKst(maintenance.start)} - ${formatKst(maintenance.end)}`;
}
